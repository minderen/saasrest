...
export const panelNav: PanelNavItem[] = [
  ...
  { to: "/panel/permissions", label: "Yetkiler", icon: ShieldCheck, scope: "super", group: "access" },
  ...
  { to: "/panel/subscriptions", label: "Abonelikler", icon: ReceiptText, scope: "super", group: "saas" },
  ...
  { to: "/panel/landing", label: "Satış sayfası", icon: Sparkles, scope: "super", group: "landing" },
  { to: "/panel/announcements", label: "Topbar duyuruları", icon: Megaphone, scope: "super", group: "landing" },
  ...
  { to: "/panel/website", label: "Website yönetimi", icon: Globe2, scope: "tenant", group: "tenant" },
  ...
  { to: "/panel/campaigns", label: "Kampanyalar", icon: CalendarClock, scope: "tenant", group: "tenant" },
  ...
  { to: "/panel/translations", label: "Çeviriler", icon: Languages, scope: "super", group: "system" },
  { to: "/panel/settings", label: "Sistem ayarları", icon: Settings, scope: "super", group: "system" },
